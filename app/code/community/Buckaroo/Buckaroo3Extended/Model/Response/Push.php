<?php
class Buckaroo_Buckaroo3Extended_Model_Response_Push extends Buckaroo_Buckaroo3Extended_Model_Response_Abstract
{
    ...
    private function decodePushValue($brqKey, $brqValue)
    {
        ...
        if (get_class($this) == 'Buckaroo_Buckaroo3Extended_Model_Response_Return') {
            return $brqValue;
        }
