<?php
class Buckaroo_Buckaroo3Extended_Model_Request_Abstract extends Buckaroo_Buckaroo3Extended_Model_Abstract
{
    protected $_vars;
    protected $_method;
    ...
    protected function _sendRequest()
    {
        ...
        /** @var Buckaroo_Buckaroo3Extended_Model_Soap $soap */
    ...
    protected function _addSoftwareVariables()
    {
        ...
        $moduleVersion = (string) Mage::getConfig()->getModuleConfig("Buckaroo_Buckaroo3Extended")->version;
