<?php
class Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Payperemail_Observer extends Buckaroo_Buckaroo3Extended_Model_Observer_Abstract
{
    ...
    public function buckaroo3extended_push_custom_processing(Varien_Event_Observer $observer)
    {
        ...
        /**
         * @var Buckaroo_Buckaroo3Extended_Model_Response_Push $push
    ...
    public function buckaroo3extended_return_custom_processing(Varien_Event_Observer $observer)
    {
         ...
         *
         * @var array $pushData
         * @var Buckaroo_Buckaroo3Extended_Model_Response_Return $return
         */
