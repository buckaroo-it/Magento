 ...
 */
class Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Dankort_Observer extends Buckaroo_Buckaroo3Extended_Model_Observer_Abstract
{
    protected $_code = 'buckaroo3extended_dankort';
    protected $_method = 'dankort';
    ...
    public function buckaroo3extended_return_custom_processing(Varien_Event_Observer $observer)
    {
        ...
        if (isset($response['brq_SERVICE_dankort_Enrolled']) && isset($response['brq_SERVICE_dankort_Authentication'])) {
            $enrolled = $response['brq_SERVICE_dankort_Enrolled'];
             ...
             */
            $authenticated = $response['brq_SERVICE_dankort_Authentication'];
