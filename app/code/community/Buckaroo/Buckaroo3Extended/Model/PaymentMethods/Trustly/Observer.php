<?php
class Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Trustly_Observer extends Buckaroo_Buckaroo3Extended_Model_Observer_Abstract
{
    
    protected $_code = 'buckaroo3extended_trustly';
    protected $_method = 'trustly';
    ...
    public function buckaroo3extended_request_addcustomvars(Varien_Event_Observer $observer)
    {
        ...
        $array = array(
            ...
            'CustomerCountryCode' => $this->_billingInfo['countryCode'],
        );
