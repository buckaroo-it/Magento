<?php
class Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Alipay_Observer extends Buckaroo_Buckaroo3Extended_Model_Observer_Abstract
{
    
    protected $_code = 'buckaroo3extended_alipay';
    protected $_method = 'alipay';
    ...
    public function buckaroo3extended_request_addcustomvars(Varien_Event_Observer $observer)
    {
        ...
        $array = array(
            'UseMobileView' => Zend_Http_UserAgent_Mobile::match(
