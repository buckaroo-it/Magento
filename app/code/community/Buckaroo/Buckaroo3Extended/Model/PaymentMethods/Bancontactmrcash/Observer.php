<?php
class Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Bancontactmrcash_Observer
    extends Buckaroo_Buckaroo3Extended_Model_Observer_Abstract
{
    ...
    public function buckaroo3extended_refund_request_addcustomvars(Varien_Event_Observer $observer)
    {
         ...
         *
         * @var Buckaroo_Buckaroo3Extended_Model_Refund_Request_Abstract $refundRequest
         */
        $refundRequest = $observer->getRequest();
        $vars = $refundRequest->getVars();
