...
class Buckaroo_Buckaroo3Extended_Model_PaymentMethods_PaymentMethod extends Mage_Payment_Model_Method_Abstract
{
    ...
    protected $_orderMailStatusses      = array( Buckaroo_Buckaroo3Extended_Model_Response_Abstract::BUCKAROO_SUCCESS);
    ...
    public function isAvailable($quote = null)
    {
        ...
        if(!Buckaroo_Buckaroo3Extended_Model_Request_Availability::canUseBuckaroo($quote)){
            return false;
        }
    ...
    public function getPosPaymentTerminalId()
    {
        ...
        $cookieName = Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Pospayment_PaymentMethod::POSPAYMENT_COOKIE;
        $value = $request->getCookie($cookieName);

        if (!$value || strlen($value) <= 0) {
            $xHeaderName = Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Pospayment_PaymentMethod::POSPAYMENT_XHEADER;
