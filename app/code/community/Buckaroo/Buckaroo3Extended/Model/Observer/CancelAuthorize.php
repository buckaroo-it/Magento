 ...
 */
class Buckaroo_Buckaroo3Extended_Model_Observer_CancelAuthorize extends Mage_Core_Model_Abstract
{
    /** @var array */
    ...
    public function sales_order_payment_cancel_authorize(Varien_Event_Observer $observer)
    {
        ...
        if (in_array($paymentMethodCode, $this->_allowedMethods)
            ...
            /** @var Buckaroo_Buckaroo3Extended_Model_Request_CancelAuthorize $cancelAuthorizeRequest */
