 ...
 */
class Buckaroo_Buckaroo3Extended_Model_Observer_Afterpay20CreateInvoice extends Mage_Core_Model_Abstract
{
    const XPATH_BUCKAROO_AFTERPAY20_INVOICE_WHEN_SHIPPING = 'buckaroo/buckaroo3extended_afterpay20/auto_invoice_when_shipping';
    const XPATH_BUCKAROO_AFTERPAY20_INVOICE_CAPTURE_TYPE  = 'buckaroo/buckaroo3extended_afterpay20/auto_invoice_capture_mode';

    /**
     * This observer is triggerd by: sales_order_shipment_save_after
     * When the payment is Afterpay20 and the option auto_invoice_when_shipping is enabled in the advanced settings
     * of the Afterpay20 configuration, the invoice will automaticly be created.
     *
    ...
    public function salesOrderShipmentSaveAfter(Varien_Event_Observer $observer)
    {
        ...
        if (!$this->_isAfterpay20Payment($order)) {
            return $this;
        }
        ...
        if (empty($qtys)) {
            Mage::throwException(
                Mage::helper('core')->__(
                    'Cannot create an invoice, because Afterpay20 can not work with an empty qtys array'
                )
            );
        }
     ...
     * @return bool
     */
    protected function _isAfterpay20Payment(Mage_Sales_Model_Order $order)
    {
        ...
        return $paymentMethodCode == 'afterpay20';
    }
    ...
    {
        return Mage::getStoreConfig(static::XPATH_BUCKAROO_AFTERPAY20_INVOICE_CAPTURE_TYPE, $storeId);
    }
    ...
    {
        return Mage::getStoreConfigFlag(static::XPATH_BUCKAROO_AFTERPAY20_INVOICE_WHEN_SHIPPING, $storeId);
    }
}
