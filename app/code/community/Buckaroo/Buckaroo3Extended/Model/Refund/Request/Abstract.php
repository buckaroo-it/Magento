<?php
class Buckaroo_Buckaroo3Extended_Model_Refund_Request_Abstract extends Buckaroo_Buckaroo3Extended_Model_Request_Abstract
{
    protected $_payment;
    protected $_invoice;
    protected $_amount;
    ...
    public function __construct($data) 
    {
        if (strpos(__DIR__, '/Model') !== false) {
            ...
            $dir = str_replace('/includes/src', '/app/code/community/Buckaroo/Buckaroo3Extended/certificate', __DIR__);
        }
    ...
    /**
     * @return $this|Buckaroo_Buckaroo3Extended_Model_Refund_Request_Abstract
     */
    ...
    protected function _sendRefundRequest($overwriteVariables = [])
    {
        ...
        /** @var $soap Buckaroo_Buckaroo3Extended_Model_Soap */
     ...
     *
     * @see Buckaroo_Buckaroo3Extended_Model_Request_Abstract::_addOrderVariables()
     */
