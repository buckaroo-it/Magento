<?php
class Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Afterpay_Checkout_Form
    extends Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Checkout_Form_Abstract
{
    ...
    public function getTosUrl()
    {
        ...
        switch ($paymentMethod) {
            case Buckaroo_Buckaroo3Extended_Model_Sources_AcceptgiroDirectdebit::AFTERPAY_PAYMENT_METHOD_DIGIACCEPT:
                $url = $this->getDigiacceptUrl();
                break;
            case Buckaroo_Buckaroo3Extended_Model_Sources_AcceptgiroDirectdebit::AFTERPAY_PAYMENT_METHOD_ACCEPTGIRO:
            default:
    ...
    protected function businessIsB2C()
    {
        ...
        if ($business == Buckaroo_Buckaroo3Extended_Model_Sources_BusinessToBusiness::AFTERPAY_BUSINESS_B2B) {
            $result = false;
        }
