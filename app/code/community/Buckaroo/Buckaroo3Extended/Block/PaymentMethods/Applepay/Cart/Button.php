<?php
class Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Applepay_Cart_Button
    extends Mage_Adminhtml_Block_Abstract
{
    ...
    /**
     * Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Applepay_Cart_Button constructor.
     */
