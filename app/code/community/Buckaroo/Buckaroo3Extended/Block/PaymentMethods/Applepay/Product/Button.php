<?php
class Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Applepay_Product_Button
    extends Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Applepay_Cart_Button
{
    /**
     * @return mixed
     */
