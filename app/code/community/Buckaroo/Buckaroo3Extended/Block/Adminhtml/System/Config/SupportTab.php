<?php
class Buckaroo_Buckaroo3Extended_Block_Adminhtml_System_Config_SupportTab
    extends Mage_Adminhtml_Block_Abstract
    implements Varien_Data_Form_Element_Renderer_Interface
{
    const XPATH_BUCKAROO_STABILITY = 'buckaroo/magento1/stability';
    ...
    public $totalEmail           = '<a href="mailto:support@buckaroo.nl">';
    ...
    {
        $config = Mage::getConfig()->getModuleConfig('Buckaroo_Buckaroo3Extended');
