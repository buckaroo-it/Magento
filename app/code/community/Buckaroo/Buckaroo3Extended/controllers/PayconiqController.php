 ...
 */
class Buckaroo_Buckaroo3Extended_PayconiqController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function sendCancelRequest()
    {
        ...
        /** @var Buckaroo_Buckaroo3Extended_Model_Request_CancelAuthorize $cancelRequest */
    ...
    {
        $order = $this->getOrder();
        $errorMessagePath = Buckaroo_Buckaroo3Extended_Model_Response_Abstract::BUCK_RESPONSE_CANCELED_BY_USER;
