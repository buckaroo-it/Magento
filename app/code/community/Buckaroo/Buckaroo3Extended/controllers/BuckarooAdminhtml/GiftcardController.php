 ...
 */
class Buckaroo_Buckaroo3Extended_BuckarooAdminhtml_GiftcardController extends Mage_Adminhtml_Controller_Action
{
    protected function _construct()
    {
        $this->setUsedModuleName('Buckaroo_Buckaroo3Extended');
    }
