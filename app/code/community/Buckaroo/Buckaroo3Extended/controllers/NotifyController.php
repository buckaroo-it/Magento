 ...
 */
class Buckaroo_Buckaroo3Extended_NotifyController extends Mage_Core_Controller_Front_Action
{
    ...
    public function returnAction()
    {
        ...
        if (isset($postData['brq_transaction_method'])
            ...
            /**
             * @var Buckaroo_Buckaroo3Extended_Model_Response_MasterPass $module
             */
            try {
        ...
        /**
         * @var Buckaroo_Buckaroo3Extended_Model_Response_Return $module
         */
        $module = Mage::getModel(
    ...
    protected function _updateTransferPartialPaid()
    {
        ...
        /** @var Buckaroo_Buckaroo3Extended_Model_Response_Push $module */
        $module = Mage::getModel(
    ...
    protected function _newRefund()
    {
        ...
        $module = Mage::getModel(
            'Buckaroo_Buckaroo3Extended_Model_Refund_Creditmemo',
            array(
                'order'      => $this->_order,
                'postArray'  => $this->_postArray,
                'debugEmail' => $this->_debugEmail,
