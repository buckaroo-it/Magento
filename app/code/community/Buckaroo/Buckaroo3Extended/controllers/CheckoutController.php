 ...
 */
class Buckaroo_Buckaroo3Extended_CheckoutController extends Mage_Core_Controller_Front_Action
{
    ...
    public function pospaymentCheckStateAction()
    {
        ...
        /** @var Buckaroo_Buckaroo3Extended_Model_Response_Abstract $responseHandler */
