 ...
 */
class Buckaroo_Buckaroo3Extended_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
    ...
    /**
     * @var Buckaroo_Buckaroo3Extended_Model_PaymentFee_Service
     */
    ...
    {
        Mage::log($message, Zend_Log::DEBUG, 'BUCKAROO_B3E.log', $force);
    }
    ...
    {
        if (is_string($e)) {
            Mage::log($e, Zend_Log::ERR, 'BUCKAROO_B3E_Exception.log', true);
        } else {
            Mage::log($e->getMessage(), Zend_Log::ERR, 'BUCKAROO_B3E_Exception.log', true);
            Mage::log($e->getTraceAsString(), Zend_Log::ERR, 'BUCKAROO_B3E_Exception.log', true);
        }
    }
    ...
    /**
     * Alias for Buckaroo_Buckaroo3Extended_Model_PaymentFee_Service::addBuckarooFeeTaxInfo()
     *
     * @param array                                                                                   $fullInfo
     ...
     * @return array
     *
     * @see Buckaroo_Buckaroo3Extended_Model_PaymentFee_Service::addBuckarooFeeTaxInfo()
     */
    ...
    /**
     * @return Buckaroo_Buckaroo3Extended_Model_PaymentFee_Service
     */
    ...
    /**
     * @param Buckaroo_Buckaroo3Extended_Model_PaymentFee_Service $serviceModel
     *
     * @return $this
     */
    public function setServiceModel(Buckaroo_Buckaroo3Extended_Model_PaymentFee_Service $serviceModel)
    {
