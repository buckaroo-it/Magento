 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function resetMagento()
    {
        ...
        Mage::app(
            ...
            'store',
            array(
                'config_model' => 'Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_Config'
            )
        )->setResponse(new Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_Http_Response());
