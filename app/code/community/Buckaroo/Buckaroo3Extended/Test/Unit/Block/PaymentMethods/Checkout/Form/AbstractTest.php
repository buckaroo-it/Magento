 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Block_PaymentMethods_Checkout_Form_AbstractTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Checkout_Form_Abstract */
    ...
    /**
     * @return Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Checkout_Form_Abstract
     */
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Checkout_Form_Abstract();
        }
    ...
    protected function setMethodCode()
    {
        ...
        $methodMock->method('getCode')->willReturn('buckaroo_method');
    ...
    public function testGetGender($sessionGender, $customerGender, $quoteGender, $expected)
    {
        ...
        $checkoutSession->expects($this->once())
            ->method('getData')
            ->with('buckaroo_method_BPE_Customergender')
        ...
        $checkoutSession->expects($this->exactly(3))
            ...
            ->withConsecutive(
                $this->onConsecutiveCalls(
                    'buckaroo_method_customerbirthdate[day]',
                    'buckaroo_method_customerbirthdate[month]',
                    'buckaroo_method_customerbirthdate[year]'
                )
            )
