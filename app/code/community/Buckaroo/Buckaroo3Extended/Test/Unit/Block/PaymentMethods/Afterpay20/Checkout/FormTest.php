 ...
 */
class Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Afterpay20_Checkout_FormTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Afterpay20_Checkout_Form */
    ...
    /**
     * @return Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Afterpay20_Checkout_Form
     */
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Block_PaymentMethods_Afterpay20_Checkout_Form();
        }
