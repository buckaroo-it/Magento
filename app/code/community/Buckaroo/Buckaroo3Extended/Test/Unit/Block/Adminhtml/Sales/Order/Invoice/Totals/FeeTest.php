 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Block_Adminhtml_Sales_Order_Invoice_Totals_FeeTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Block_Adminhtml_Sales_Order_Invoice_Totals_Fee */
    ...
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            ...
            $this->_instance = new Buckaroo_Buckaroo3Extended_Block_Adminhtml_Sales_Order_Invoice_Totals_Fee();
    ...
    public function testInitTotalsDataprovider()
    {
        return array(
            array(
                ...
                'once',
                'once',
                Buckaroo_Buckaroo3Extended_Block_Adminhtml_Sales_Order_Invoice_Totals_Fee::DISPLAY_MODE_BOTH
            ),
            array(
                '3.14',
                'never',
                'once',
                Buckaroo_Buckaroo3Extended_Block_Adminhtml_Sales_Order_Invoice_Totals_Fee::DISPLAY_MODE_EXCL
            ),
            array(
                '1.19',
                'once',
                'once',
                Buckaroo_Buckaroo3Extended_Block_Adminhtml_Sales_Order_Invoice_Totals_Fee::DISPLAY_MODE_INCL
            ),
            array(
                '0',
                'never',
    ...
    public function testInitTotals(
        ...
        $store->setConfig(
            Buckaroo_Buckaroo3Extended_Block_Adminhtml_Sales_Order_Invoice_Totals_Fee::XPATH_DISPLAY_MODE_BUCKAROO_FEE,
            $displayMode
        );
        ...
        $this->assertInstanceOf('Buckaroo_Buckaroo3Extended_Block_Adminhtml_Sales_Order_Invoice_Totals_Fee', $result);
    }
}
