 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_PayconiqControllerTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_PayconiqController */
    ...
    /**
     * @return Buckaroo_Buckaroo3Extended_PayconiqController
     */
    protected function _getInstance()
    {
        ...
        $this->_instance = new Buckaroo_Buckaroo3Extended_PayconiqController($request, $response);
    ...
    {
        $requestBuilderMock = $this->getMockBuilder('Buckaroo_Buckaroo3Extended_Model_Request_Abstract')
    ...
    public function testCancelAction()
    {
        ...
        $cancelAuthorizeMock = $this->getMockBuilder('Buckaroo_Buckaroo3Extended_Model_Request_CancelAuthorize')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testSendCancelRequestThrowsException()
    {
        ...
        $helperMock = $this->getMockBuilder('Buckaroo_Buckaroo3Extended_Helper_Data')
