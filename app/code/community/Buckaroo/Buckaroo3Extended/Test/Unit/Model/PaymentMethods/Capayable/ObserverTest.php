 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_PaymentMethods_Capayable_ObserverTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_Observer */
    ...
    /**
     * @return null|Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_Observer
     */
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_Observer();
    ...
    public function testBuckaroo3extended_request_setmethod()
    {
        ...
        $this->assertInstanceOf('Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_Observer', $result);
