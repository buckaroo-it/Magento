 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_Response_CaptureTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_Response_Capture */
    ...
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            ...
            $this->_instance = $this->getMockBuilder('Buckaroo_Buckaroo3Extended_Model_Response_Capture')
