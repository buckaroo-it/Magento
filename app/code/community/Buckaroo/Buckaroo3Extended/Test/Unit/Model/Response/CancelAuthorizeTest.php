 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_Response_CancelAuthorizeTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_Response_CancelAuthorize */
    ...
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            ...
            $this->_instance = $this->getMockBuilder('Buckaroo_Buckaroo3Extended_Model_Response_CancelAuthorize')
                ->setMethods(
                    array(
                        '_verifyResponse',
                        '_parseResponse',
    ...
    public function testProcessResponse()
    {
        ...
        $instance->expects($this->once())->method('_parseResponse')
            ->willReturn(array('status' => Buckaroo_Buckaroo3Extended_Model_Response_Abstract::BUCKAROO_SUCCESS));
