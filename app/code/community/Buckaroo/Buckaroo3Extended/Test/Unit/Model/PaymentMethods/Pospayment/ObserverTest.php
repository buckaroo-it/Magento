 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_PaymentMethods_Pospayment_ObserverTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Pospayment_Observer */
    protected $_instance = null;

    /**
     * @return Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Pospayment_Observer
     */
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Pospayment_Observer();
        }
    ...
    public function testBuckaroo3extended_request_setmethod()
    {
        ...
        $this->assertInstanceOf('Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Pospayment_Observer', $result);
    ...
    public function buckaroo3extended_push_custom_save_invoice_afterProvider()
    {
        return array(
            'succes status' => array(
                Buckaroo_Buckaroo3Extended_Model_Abstract::BUCKAROO_SUCCESS,
                1
            ),
            'failed status' => array(
                Buckaroo_Buckaroo3Extended_Model_Abstract::BUCKAROO_FAILED,
                0
            ),
        );
    }
    ...
    public function testBuckaroo3extended_push_custom_save_invoice_after($status, $expectedCallCount)
    {
        ...
        $mockPush = $this->getMockBuilder('Buckaroo_Buckaroo3Extended_Model_Response_Push')
