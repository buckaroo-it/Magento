 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_PaymentMethods_Kbc_PaymentMethodTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Kbc_PaymentMethod */
    protected $_instance = null;

    /**
     * @return Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Kbc_PaymentMethod
     */
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Kbc_PaymentMethod();
        }
