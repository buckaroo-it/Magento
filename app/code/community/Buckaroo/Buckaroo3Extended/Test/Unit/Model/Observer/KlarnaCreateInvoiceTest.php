 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_Observer_KlarnaCreateInvoiceTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_Observer_KlarnaCreateInvoice  */
    ...
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Model_Observer_KlarnaCreateInvoice();
        }
    ...
    {
        $mockKlarnaMethod = $this->getMockBuilder('Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Klarna_PaymentMethod')
