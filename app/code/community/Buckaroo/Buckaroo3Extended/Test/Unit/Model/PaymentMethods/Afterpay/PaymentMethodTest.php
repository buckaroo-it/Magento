 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_PaymentMethods_Afterpay_PaymentMethodTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Afterpay_PaymentMethod */
    ...
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Afterpay_PaymentMethod();
        }
    ...
    public function testCapture()
    {
        ...
        $this->assertInstanceOf('Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Afterpay_PaymentMethod', $result);
    }
