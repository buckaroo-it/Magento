 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_PaymentMethods_Capayable_Installments_ObserverTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_Installments_Observer */
    ...
    /**
     * @return null|Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_Installments_Observer
     */
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_Installments_Observer();
        }
    ...
    public function testBuckaroo3extended_request_addservices()
    {
        $mockPayment = $this->getMockBuilder('Mage_Sales_Model_Order_Payment')
            ...
            ->getMock();
        $mockPayment->expects($this->any())->method('getMethod')->willReturn('buckaroo3extended_capayableinstallments');
        ...
        $this->assertInstanceOf('Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_Installments_Observer', $result);
        $this->assertEquals('PayInInstallments', $requestVarsResult['services']['Capayable']['action']);
