<?php
class Buckaroo_Buckaroo3Extended_Model_Refund_CreditmemoTest extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    ...
    {
        $creditmemo = $this->createInstanceWithoutConstructor('Buckaroo_Buckaroo3Extended_Model_Refund_Creditmemo');
