 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_PaymentMethods_Capayable_PaymentMethodTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_PaymentMethod */
    ...
    /**
     * @return null|Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_PaymentMethod
     */
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Model_PaymentMethods_Capayable_PaymentMethod();
    ...
    public function testGetOrderPlaceRedirectUrl()
    {
        $postArray = array(
            ...
            'buckaroo3extended_capayable_BPE_CompanyName' => 'Buckaroo',
        );
