 ...
 */
class Buckaroo_Buckaroo3Extended_Test_Unit_Model_Response_PushTest
    extends Buckaroo_Buckaroo3Extended_Test_Framework_Buckaroo_Test_TestCase
{
    /** @var null|Buckaroo_Buckaroo3Extended_Model_Response_Push */
    protected $_instance = null;

    /**
     * @return null|Buckaroo_Buckaroo3Extended_Model_Response_Push
     */
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new Buckaroo_Buckaroo3Extended_Model_Response_Push();
        }
