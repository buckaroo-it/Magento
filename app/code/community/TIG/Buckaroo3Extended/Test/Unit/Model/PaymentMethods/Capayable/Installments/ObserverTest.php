 ...
 */
class TIG_Buckaroo3Extended_Test_Unit_Model_PaymentMethods_Capayable_Installments_ObserverTest
    extends TIG_Buckaroo3Extended_Test_Framework_TIG_Test_TestCase
{
    /** @var null|TIG_Buckaroo3Extended_Model_PaymentMethods_Capayable_Installments_Observer */
    ...
    /**
     * @return null|TIG_Buckaroo3Extended_Model_PaymentMethods_Capayable_Installments_Observer
     */
    protected function _getInstance()
    {
        if ($this->_instance === null) {
            $this->_instance = new TIG_Buckaroo3Extended_Model_PaymentMethods_Capayable_Installments_Observer();
        }
    ...
    public function testBuckaroo3extended_request_addservices()
    {
        ...
        $this->assertInstanceOf('TIG_Buckaroo3Extended_Model_PaymentMethods_Capayable_Installments_Observer', $result);
